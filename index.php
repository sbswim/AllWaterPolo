...
<div class="header">
   <a href="index.php">
   <h1 class="title"> The Inside Game </h1>
...
<ul>
   ...
   <li> <a href="#">Attitude</li>
   <li> <a href="#"> Training </li>
      <li> <a href="#"> Injury Prevention </li>
      <li> <a href="#">Information
         <ul>
            <li> <a href="#">Rules </li>
            <li> <a href="#">Positions </li>
            <li> <a href="#">Plays </li>
            <li> <a href="#">Tournments </li>
         </ul>
         </li>
...
<div class="footer">
    ...
    <a href="#"><img src ="assets/img/Youtube_icon.png" class="youtube" id="YouTube Link" /> </a>
    <div class= copyright>
